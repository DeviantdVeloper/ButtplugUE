...
This can be circumvented by binding to the appropriate delegate/callback on the subsystem *prior* to making the request. This was you will recieve a corecrtly typed struct every time.
